...
carteiraRouter.post("/criar-carteira", (req, res) =>
  carteiraController.create(req, res),
);
carteiraRouter.delete("/deletar-carteira", (req, res) =>
  carteiraController.delete(req, res),
);
...
carteiraRouter.patch("/atualizarSaldo", (req, res) =>
  carteiraController.updateBalance(req, res),
);
carteiraRouter.get("/acharPorUserId", (req, res) =>
  carteiraController.findByUserId(req, res),
);
carteiraRouter.get("/acharPorPrestadorId", (req, res) =>
  carteiraController.findByPrestadorId(req, res),
);
